...
function Attendance() {
  ...
  const fetchAttendance = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://127.0.0.1:5000/api/staff/attendance"
      );
  ...
  const fetchCampers = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://127.0.0.1:5000/api/staff/campers"
      );
  ...
  const fetchGroups = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://127.0.0.1:5000/api/staff/groups"
      );
  ...
  const fetchCurrentlyInside = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "http://127.0.0.1:5000/api/staff/currently-inside"
      );
  ...
  const checkIn = async () => {
    ...
    const res = await fetch(
      "http://127.0.0.1:5000/api/staff/checkin",
      {
        method: "POST",
  ...
  const checkOut = async () => {
    ...
    const res = await fetch(
      "http://127.0.0.1:5000/api/staff/checkout",
      {
        method: "POST",
